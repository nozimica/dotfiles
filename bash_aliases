...
alias l='ls -l --color | less -FRX'
alias lt='ls -lt --color | less -FRX'
alias lat='ls -lat --color | less -FRX'
alias lsz='ls -la | sort -k 5 -nr | less -FRX'
alias lsnoz='ls -la | sort -k 3 | grep ${USER}'
alias d='ls -lA --color | less -FRX'
alias dl='ls -lA --color --group-directories-first | less -FRX'
alias ll='ls | less -FRX'
alias c='clear'
alias ddd='ls | less -FRX'
alias bello='telnet Biblios.dic.uchile.cl'
alias duk='du -k | sort -nr | less -FRX'
...
alias dt='ls -lt | less -FRX'
alias lspdf='ls *.pdf | less -FRX'
alias psnoz="ps -U ${USER}"
alias tmp='cd /tmp'
alias vtmp='cd /var/tmp'
alias dukk='dukk | less -FRX'
alias vi='vim'
